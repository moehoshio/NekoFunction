/**
 * @file test.cpp
 * @brief Minimal integration test for NekoFunction via Conan
...
int main() {
    std::cout << "=== NekoFunction Conan Integration Test ===" << std::endl;
    ...
    std::cout << "NekoFunction is correctly installed via Conan." << std::endl;
